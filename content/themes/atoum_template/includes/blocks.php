<?php
	...
	/* Thoses functions allow you to import custom template for some HTML elements. */

	$BLOCKS = $LINKS['THEMES'] . $THEME . '/includes/blocks/';
	...
	include $BLOCKS . 'preformatted_text.php';
